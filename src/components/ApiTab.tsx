      ...
      {config.exchange === 'bingx' && (
        <div className="info-box">
          ...
          <ol>
            ...
            <li>For Demo Trading: Click "Demo Trading" in top right, then go to API Management</li>
            <li>For Real Trading: Stay in normal mode, go to Account → API Management</li>
          ...
          <p style={{marginTop: '1rem', fontSize: '0.9rem', color: '#666'}}>
            💡 If you see VST balance, you're connected to Demo Trading. If USDT balance, you're in Production.
          </p>
        </div>
      )}
    </section>
